...
def detect_questions_from_pdf(pdf_path: str, question_ids: list, model_name: str = MODEL_NAME) -> str:
    client = genai.Client(
        vertexai=True,
        project=PROJECT_ID,
        location=LOCATION,
...
def detect_question_pages(pdf_path: str, question_ids: list, model: str = MODEL_NAME) -> Dict[str, Any]:
